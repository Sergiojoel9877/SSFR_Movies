...
{
    public class CustomViewCellFavListPage : ViewCell
    {
        #region Controls
        ...
        public CustomViewCellFavListPage()
        {
            ...
            AddToFavListCtxAct = new MenuItem { Text = "Quit from Favorites", Icon = "StarEmpty.png" };
